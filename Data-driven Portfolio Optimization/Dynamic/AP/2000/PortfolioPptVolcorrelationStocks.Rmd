...
plot(price_data1$HNRG, type = "l", ylab='', main='Price (HNRG)', cex.main = 2, cex.lab = 1.5, cex.axis = 1.5, lwd=4.0, col = "blue")
```
...
stat <- matrix(0, nrow = nportfolios, ncol = 7)
weight <- matrix(0, nrow = nportfolios, ncol = nasset)
...
```{r}
asset_columns <- colnames(max_sr4)[1:21]
...
portfolio_values1_annual <- portfolio_values1 %>% mutate(Return = Return * 252) %>% mutate(Risk1 = Risk1 * sqrt(252), Risk2 = Risk2 * sqrt(252), Risk3 = Risk3 * sqrt(252), Risk4 = Risk4 * sqrt(252), Risk5 = Risk5 * sqrt(252)) %>% mutate(SharpeRatio1 = SharpeRatio1 * sqrt(252), SharpeRatio2 = SharpeRatio2 * sqrt(252), SharpeRatio3 = SharpeRatio3 * sqrt(252), SharpeRatio4 = SharpeRatio4 * sqrt(252), SharpeRatio5 = SharpeRatio5 * sqrt(2))
```
