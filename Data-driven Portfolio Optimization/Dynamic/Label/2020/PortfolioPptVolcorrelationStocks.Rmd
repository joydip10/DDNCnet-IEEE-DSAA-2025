...
```{r}
asset_columns <- colnames(min_var4)
...
```{r}
asset_columns <- colnames(max_sr4)[1:7]
...
p2 <- max_sr4 %>%
  ...
  geom_bar(stat = 'identity') +
  theme_minimal() +
  labs(x = 'Assets', y = 'Weights', title = "Maximum Sharpe Ratio Portfolio Weights (All selected Stocks)") +
  scale_y_continuous(labels = scales::percent)
